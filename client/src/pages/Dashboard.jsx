...
//     return (
//         <div className="min-h-screen bg-gradient-to-br from-slate-100 via-gray-100 to-slate-200 flex">

//             {/* Sidebar */}
//             <div className="w-64 bg-gradient-to-b from-black to-gray-900 text-white p-6 shadow-lg">
...
//                     <li className="hover:text-white cursor-pointer transition">Study</li>
//                 </ul>
//             </div>

//             {/* Main Content */}
//             <div className="flex-1 p-8 bg-gradient-to-br from-slate-100 via-gray-100 to-slate-200">
...
//                         <p className="text-3xl font-bold mt-2">5 hrs</p>
//                     </div>
...
//                         <li className="flex justify-between items-center bg-gray-100 p-4 rounded-xl hover:bg-gray-200 transition">
//                             <span className="font-medium">Complete DSA practice</span>
...
//                         <li className="flex justify-between items-center bg-gray-100 p-4 rounded-xl hover:bg-gray-200 transition">
//                             <span className="font-medium">Revise OS notes</span>
...
//                         <li className="flex justify-between items-center bg-gray-100 p-4 rounded-xl hover:bg-gray-200 transition">
//                             <span className="font-medium">Work on project</span>
//                             <span className="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-sm">
//                                 Pending
//                             </span>
//                         </li>
